...
public class ParticipantesEmpty extends AppCompatActivity implements View.OnClickListener {
    ImageView btnLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_participantes_empty);
    ...
    private void actividad(int opciones) {
        switch (opciones) {
            ...
            case R.id.btnPagarFactura2:
                intent = new Intent(this, participantes_full.class);
                launcher.launch(intent);
                break;

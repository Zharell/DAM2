...
<body>
    <h1>PharmaDam</h1>
    <h3>Visitas:
        <?php include 'php/visitas.php'; ?>
    </h3>
    <div class="margen">
        <section class="margenTablas">
            <form method="post" id="formulario">
                <input type="submit" style="background-image: url(recursos/img/conductor.jpg)" alt="submit"
                    id="conductor" name="conductor" value="">
                ...
                <input type="submit" style="background-image: url(recursos/img/viaje.jpg)" alt="submit" id="viaje"
                    name="viaje" value="">
                <input type="submit" style="background-image: url(recursos/img/logoPharmadam.jpg)" alt="submit"
                    id="salir" name="salir"  onclick="return confirm('¿Estás seguro de que deseas cerrar sesión?')" value="">
            </form>
        </section>
    </div>
    <div>

...
if (isset($_POST['conductor'])) {
    ...
    echo '<iframe src="tablas/conductores/crud/PagCrear.php" style="width:100px; height:100px;"></iframe>';
    ...
    foreach ($result as $row) {
        echo
            "<tr>
             <td><a href='tablas/conductores/crud/conductoresViajeros.php?id=" . $row["id"] . "' target='_self'>" . $row["id"] . "</a></td>"
            . "<td>" . $row["nombre"] . "</td>"
            . "<td>" . $row["apellidos"] . "</td>"
            . "<td>" . $row["dni"] . "</td>"
            . "<td>" . $row["matricula"] . "</td>"
